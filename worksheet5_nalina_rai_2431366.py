# -*- coding: utf-8 -*-
"""worksheet5_nalina_rai_2431366.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11_C-ajfaZKOXYJT5ZkmEgUmkFczYdgYs
...
data = pd.read_csv("/content/drive/MyDrive/Worksheet5/student.csv")
data.head()
...
print(data.tail())  # Displays the last 5 rows

# 3. Print the Information of Datasets. {Hint: pd.info}.

print("\nInformation of the dataset:")
print(data.info())  # Displays information about the DataFrame

# 4. Gather the Descriptive info about the Dataset. {Hint: pd.describe}

print("\nDescriptive Statistics of the dataset:")
print(data.describe())  # Shows mean, std, min, max, etc. for numerical columns
...
def main():
    # Load the dataset
    data = pd.read_csv("/content/drive/MyDrive/Worksheet5/student.csv")  # Replace with your actual CSV file
